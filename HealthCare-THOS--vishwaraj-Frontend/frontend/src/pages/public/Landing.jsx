...
.landing-root .hero-visual {
  height:455px;position:relative;display:flex;align-items:center;justify-content:center;
}
.landing-root .visual-orbit {
  position:absolute;width:430px;height:430px;border:1px dashed rgba(39,135,132,.28);border-radius:50%;
}
.landing-root .family-wrap {
  position:relative;width:390px;height:430px;display:flex;align-items:flex-end;justify-content:center;
  overflow:hidden;border-radius:48% 48% 12px 12px;
}
.landing-root .family-wrap:before {
  content:"";position:absolute;inset:30px 5px 0;border-radius:50% 50% 12px 12px;background:radial-gradient(circle at 50% 35%,#edf9f9 0,#e7f4f3 48%,transparent 72%);
}
.landing-root .family-wrap img {
  width:100%;height:100%;object-fit:cover;object-position:center 20%;position:relative;z-index:1;
  mix-blend-mode:multiply;
}
.landing-root .floating-card {
  position:absolute;background:rgba(255,255,255,.96);border:1px solid rgba(27,58,76,.07);border-radius:19px;
  padding:18px 19px;box-shadow:0 10px 28px rgba(29,54,70,.10);z-index:3;
  width:158px;min-height:124px;
}
.landing-root .floating-card svg { width:34px;height:34px;margin-bottom:7px; }
.landing-root .floating-card strong { display:block;font-size:14px;margin-bottom:5px; }
.landing-root .floating-card span { font-size:10px;line-height:1.55;color:#566274;display:block; }
.landing-root .card-hospital { left:0;top:58px;text-align:center; }
.landing-root .card-hospital svg { color:#176f8c; }
.landing-root .card-mental { right:8px;top:50px;text-align:center; }
.landing-root .card-mental svg { color:#4b9d7a; }
.landing-root .card-physical { right:38px;bottom:53px;text-align:center; }
.landing-root .card-physical svg { color:var(--orange); }
.landing-root .connected {
  position:absolute;z-index:4;bottom:8px;left:50%;transform:translateX(-50%);
  background:white;border-radius:19px;padding:14px 22px;box-shadow:0 10px 28px rgba(29,54,70,.12);
  display:flex;align-items:center;gap:12px;font-size:13px;font-weight:700;white-space:nowrap;
}
.landing-root .connected svg { color:#4aa890;width:29px;height:29px; }
          ...
          <section className="hero">
            ...
            <div className="hero-visual" aria-label="Healthcare family illustration">
              ...
              <div className="family-wrap">
                <img src="/assets/landing-hero-family.png" alt="Family using Healthcare+" />
              </div>
