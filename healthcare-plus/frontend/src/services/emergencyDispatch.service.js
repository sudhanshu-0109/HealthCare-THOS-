...
export const updateLocation = (latitude, longitude, heading, speed) =>
  api.post('/driver/location', { latitude, longitude, heading, speed });
...
export const markReached = (requestId) => api.post(`/driver/requests/${requestId}/reached`);  // Backup manual trigger
